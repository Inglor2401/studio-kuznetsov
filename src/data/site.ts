...
export type Principle = {
  ...
  title: string;
  text: string;
  label: string;     // короткое тематическое слово для editorial-индекса слева
};
...
С нами работают семьи, которые строят свой первый и единственный дом, а не очередную квартиру под сдачу. Поэтому мы не торопимся: средний цикл проекта — от 14 до 22 месяцев.`,
  ...
  // Lead-абзац для блока studio-teaser на главной — разворачивает позиционирование,
  // не дублируя bioShort из hero overlay.
  studioTeaserLead: 'С нами работают семьи, которые строят свой первый и единственный дом, — а не очередную квартиру под сдачу. Поэтому средний цикл проекта — от 14 до 22 месяцев.',
